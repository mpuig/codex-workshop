...
In the [previous section](/vibe-coding) you used planning-first prompts to ask Codex to show its approach before acting. That works well for focused tasks like "add a filter to the dashboard."
