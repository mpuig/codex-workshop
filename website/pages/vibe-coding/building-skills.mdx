---
title: "Building Skills for Codex"
description: Learn what skills are, how to structure them, and best practices for creating repeatable insurance workflows that Codex can follow consistently.
---
...
For more on how skills work across Codex's different interfaces, see [Appendix A: Codex Cowork](/appendix/codex-cowork#plugins-and-skills).
