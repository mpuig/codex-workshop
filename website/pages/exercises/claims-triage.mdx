...
2. Download the three data files into the `data/` folder:
   <ul>
     <li><a href="../data/exercise-3/incoming_claims.csv" download>incoming_claims.csv</a></li>
     <li><a href="../data/exercise-3/historical_outcomes.csv" download>historical_outcomes.csv</a></li>
     <li><a href="../data/exercise-3/business_rules.json" download>business_rules.json</a></li>
   </ul>
3. Open your terminal in the `claims-triage/` folder and start OpenAI Codex
