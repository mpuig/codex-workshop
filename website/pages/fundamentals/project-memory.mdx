---
title: "Module 2.2: Project Memory with AGENTS.md"
...
```mermaid
flowchart TB
  G["~/.codex/AGENTS.md<br/>Global defaults (all projects)"]
  P["/project/AGENTS.md<br/>Project rules"]
  S["/project/submodule/AGENTS.md<br/>Optional nested overrides"]
  C["Codex session in /project/submodule"]
