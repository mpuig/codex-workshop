...
description: "Install OpenAI Codex, authenticate, and run your first session in 5 minutes."
---
...
Then proceed to [Module 1.1: First Steps with OpenAI Codex](/fundamentals/first-steps) to learn how to give effective instructions and complete your first insurance tasks.
