...
Proceed to [Module 3: Building an Insurance App with Vibe Coding](/vibe-coding) to learn how non-technical users can build working applications with OpenAI Codex.
