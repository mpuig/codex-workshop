...
> **Time:** 30 minutes | **Prerequisites:** [Module 3.1: Underwriting Brief](/insurance-workflows/underwriting-brief)
...
Once you have the data, ask OpenAI Codex to perform the analysis.
...
> **Note:** OpenAI Codex will likely create these as HTML files with embedded JavaScript charts (using a library like Chart.js). You can open them in any web browser by double-clicking the file.
...
The key takeaway: **OpenAI Codex significantly speeds up spreadsheet-heavy analysis.** When you ask OpenAI Codex to write and execute scripts for calculations, the math is exact. Still, spot-check at least two or three results against your own math -- this confirms the script logic is correct, not only the arithmetic.

---

## Next Step

Proceed to [Module 3.3: Market Entry Assessment](/insurance-workflows/market-assessment) to learn how OpenAI Codex can help with strategic analysis using web research.
