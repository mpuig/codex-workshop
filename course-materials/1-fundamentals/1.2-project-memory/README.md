...
Every time you start a new Codex session, it starts with a blank slate. It does not remember that you work at MIG, that you prefer tables over paragraphs, or that all figures should be in EUR. You end up repeating the same context every time.

**AGENTS.md solves this.** It is a file that Codex reads automatically at the start of every session, giving it persistent memory about your project, preferences, and rules.

---

## What Is AGENTS.md?

AGENTS.md is a plain text file you place in your project folder. When you start Codex in that folder, it reads the file before you say anything. Think of it as a briefing document you hand to a new team member on their first day.
