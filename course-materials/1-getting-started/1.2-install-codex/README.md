...
## Optional Warmup: See the Value First

If you want a quick confidence boost before installing anything, do this 5-minute warmup in ChatGPT.
...
```text
Analyze this CSV file. Give me high-level statistics about the claims.
```

```text
Which regions and claim types stand out? Keep it brief and business-focused.
```

```text
Show me a chart of the highest-incurred regions.
```

This is not the main workflow for the course. It is just a quick way to see what an AI tool can already do with insurance data before you move into the Codex CLI.
...
PowerShell equivalent for API-key login:
...
Then proceed to [Module 2.1: First Steps with OpenAI Codex](../../2-fundamentals/2.1-first-steps/README.md) to learn how to give effective instructions and complete your first insurance tasks.
